...
MIDDLEWARE = [
    ...
    "apps.tracks.middleware.AuditActorMiddleware",
...
# Fila dedicada deste serviço. Como o RabbitMQ é compartilhado com outros
# serviços (notification...), cada worker escuta a SUA fila nomeada em vez da
